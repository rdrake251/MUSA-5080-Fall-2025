...
**"Which low-income census tracts in rural areas lack access to hospitals?"**

**Your Task:** Combine what you've learned to identify vulnerable, underserved communities.

**Steps:**
1. Get income data for census tracts
2. Identify low-income tracts (median income < $40,000)
3. Filter for rural tracts only (not in metro areas)
...
**Key Insight:** Always check and standardize CRS when working with spatial data from multiple sources!